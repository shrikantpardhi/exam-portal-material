      ...
      >
        <CardContent>
          <Grid container direction="column">
            ...
            <Divider />
            <Grid item sx={{ m: 1 }}>
              <Typography>{props.exam.examDescription}</Typography>
            </Grid>
            <Divider />
            <Grid item sx={{ p: 1 }}>
              <Grid container justifyContent="space-between" spacing={1}>
            ...
            <Grid item sx={{ p: 1 }}>
              <Grid container justifyContent="space-between" spacing={1}>
                <CardRow
                  name="Negative"
                  value={props.exam.isNegativeAllowed === 0 ? "No" : "Yes"}
                />
                <CardRow
                  name="End Date"
                  value={props.exam.examEndDate.toString()}
                />
              </Grid>
            </Grid>
          </Grid>
